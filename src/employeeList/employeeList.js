...
sidemenu = (evt) =>{
  const val = evt.target.value;
  window.sessionStorage.setItem("isRole",val)
  console.log(val);
                ...
                <div className="row ml-2">
                  ...
                  <div className="col ">
                    <Container className="shadow p-40 bg-light">
                      ...
                      <Row className="p-20 ml-5" md={4}>
                      <select
                                  className="form-control "
                                  onChange={(evt) => this.sidemenu(evt)}
                                >
                                  <option selectedx>{window.sessionStorage.getItem("isRole")}</option>
                                  <option value="commercial">commercial</option>
                                  <option value="company">company</option>
                                  <option  value="balbhas">balbhas</option>
